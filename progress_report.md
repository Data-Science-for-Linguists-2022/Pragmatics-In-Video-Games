...
However, in regards to my analysis, I have hit several major road blocks and I intend to speak to you about these as soon as possible. Firstly, as noted in `analysis.ipynb` under the second hypothesis, there's no readily available list of deictic English words, meaning I am currently trying to create my own (with very little success). Secondly, while _COCA_ has provided useful insight, I am confused as to how I can interpret the data it provides me when I search its archives. I'm hoping in the long run that these turn out to be only minor setbacks, but, should push come to shove, I will not hesitate on trying different questions or hypothesis. Nevertheless, I am concerned about my analysis grade for this progress report since I feel like I haven't made much headway due to these issues.
